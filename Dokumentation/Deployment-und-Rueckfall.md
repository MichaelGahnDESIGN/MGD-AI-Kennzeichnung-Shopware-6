...
Ohne diese Option entfernt das Plugin sein eindeutig geprüftes Medienfeld-Set einschließlich Felddefinitionen und Medienrelation, alle globalen und verkaufskanalspezifischen Zeilen seiner neun Konfigurationsschlüssel sowie die eigentumsgeprüfte Snapshot-Tabelle. Die explizite Scope-Bereinigung verhindert, dass Shopware 6.6 kanalbezogene Restwerte zurücklässt. Medien, fremde Tabellen und fremde Custom Fields bleiben erhalten. Bereits in Medien-JSON gespeicherte Schlüssel können als technisch ungenutzte Werte bestehen bleiben, weil keine automatische Massenbereinigung der Medien erfolgt. Ein zuvor erstelltes Philosophie-Layout bleibt ebenfalls bestehen und muss nach redaktioneller Prüfung bei Bedarf manuell entfernt werden.
